...
export default function Create({ celulares, computadoras, productosGenerales }) {
  ...
  useEffect(() => {
    if (
      ...
      productoSeleccionado.codigo.length >= 2 &&
      productoSeleccionado.tipo
    ) {
      buscarSugerencias(productoSeleccionado.codigo);
    } else {
      setMostrarProductos(false);
    }
  }, [
    ...
    stocks.celulares,
    stocks.computadoras,
    stocks.productosGenerales,
    stocks.productosApple,
  ]);
